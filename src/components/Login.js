...
const Login = () => {
  ...
  return (
    <div>
        ...
        <form onSubmit={(e)=>e.preventDefault()} className='w-3/12 bg-black bg-opacity-70 rounded-lg absolute p-12 my-36 mx-auto right-0 left-0 text-white'>
            <h1 className='font-bold text-3xl my-4 mx-2'>Sign In</h1>
            ...
            <button className='p-4 my-6 bg-red-800 w-full rounded-lg' onClick={handleButtonClick}>Sign In</button>
